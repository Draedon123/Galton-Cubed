...
class Matrix4 {
  ...
  public copyFrom(matrix: Matrix4): this {
    this.components[0] = matrix.components[0];
    this.components[1] = matrix.components[1];
    this.components[2] = matrix.components[2];
    this.components[3] = matrix.components[3];
    this.components[4] = matrix.components[4];
    this.components[5] = matrix.components[5];
    this.components[6] = matrix.components[6];
    this.components[7] = matrix.components[7];
    this.components[8] = matrix.components[8];
    this.components[9] = matrix.components[9];
    this.components[10] = matrix.components[10];
    this.components[11] = matrix.components[11];
    this.components[12] = matrix.components[12];
    this.components[13] = matrix.components[13];
    this.components[14] = matrix.components[14];
    this.components[15] = matrix.components[15];
  ...
  public invert(): this {
    ...
    if (determinant < 1e-8) {
      console.warn("Determinant is too close to 0. Matrix not inverted");
      return this;
    }
